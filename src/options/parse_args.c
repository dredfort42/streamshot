...
/**
 * @brief Parses a command-line argument at the specified index and returns it as an argument_t
 * structure.
 *
 ...
 *
 * @return       Pointer to a dynamically allocated argument_t structure containing the parsed key
